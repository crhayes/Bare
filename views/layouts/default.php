...
<html>
  <head>
    ...
    <? section('styles') ?>
        ...
        <!--
        <link rel="stylesheet" type="text/css" href="<?= asset('css/colorbox/style-1.css') ?>">
        -->
        <!--[if IE 7]><link rel="stylesheet" href="<?= asset('css/font-awesome-ie7.min.css') ?>"><![endif]-->
    <? close() ?>
  </head>
  <body>
    ...
    <? section('scripts') ?>
        ...
        <script type="text/javascript" src="<?= asset('js/less-1.3.0.min.js') ?>"></script>
        <script type="text/javascript" src="<?= asset('js/form-default-toggle.js') ?>"></script>
